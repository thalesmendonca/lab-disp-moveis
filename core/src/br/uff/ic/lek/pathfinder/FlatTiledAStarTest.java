...
public class FlatTiledAStarTest extends PathFinderTestBase {
	...
	public void create (Table table) {
		...
		int roomCount = MathUtils.random(30,150);// 100, 260);//70, 120);
		int roomMinSize = 3;
		int roomMaxSize = 15;
	...
	@Override
	public void render () {
		// LEK o render deve ser o TiledMap de sprites e nao esse de retangulos pretos, cinzas, brancos e vermelhos(linha)
		...
		renderer.setColor(Color.PURPLE); // LEK troquei para mostrar que o codigo eh diferente
